...
function ProductModal({ id, url, img_url, author, title, price }) {
    ...
    <>
      ...
      >
        <Container>
          ...
          <InputStyle
            defaultValue={url}
            onChange={(text) => setNewPrice(text.target.value)}
          />
          <label>
            <b>Image URL</b>
          </label>
          <InputStyle
            ...
            onChange={(text) => setNewUrl(text.target.value)}
          />
          <label>
            <b>Author</b>
          </label>
          <InputStyle
            defaultValue={author}
            onChange={(text) => setNewAuthor(text.target.value)}
          />
          <label>
            <b>Title</b>
          </label>
          ...
          <InputStyle
            ...
            onChange={(text) => setNewPrice(text.target.value)}
          />
          <ButtonUpdate onClick={() => updateProduct()}>Update</ButtonUpdate>
        </Container>
      </Modal>
    </>
  )
